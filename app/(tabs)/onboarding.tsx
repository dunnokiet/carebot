      ...
      <View className="w-screen items-center justify-start gap-4">
        ...
        <View className="flex-clo justify-center gap-4">
          <Button
            ...
            onPress={completeOnboarding}
          >
            <Text className="font-semibold text-foreground">Do not allow</Text>
          </Button>
          <Button
            variant="default"
            className="min-w-72 flex-row items-center justify-center gap-x-2 rounded-2xl"
            onPress={completeOnboarding}
          >
            <Text className="font-semibold text-background">Allow</Text>
          </Button>
        </View>
      </View>
    );
    ...
    return (
      <View className="w-screen items-center justify-start gap-4">
        ...
        <Button
          ...
          onPress={completeOnboarding}
        >
          <Text className="font-semibold text-primary">Skip login</Text>
        </Button>
      </View>
    );
  }
