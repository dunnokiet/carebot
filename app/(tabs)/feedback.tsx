...
export default function FeedbackScreen() {
  ...
  const [feedbackType, setFeedbackType] = useState<"complaint" | "suggestion" | "bug">("complaint");
  ...
  const FeedbackTypeButton = ({ type, label }: { type: "complaint" | "suggestion" | "bug", label: string }) => (
    <TouchableOpacity
    ...
    return (
      <SafeAreaView className="flex-1 bg-background">
        <View className="flex-1 items-center justify-center p-6">
          <Icon icon={CheckCircle} className="mb-6 h-24 w-24 text-primary" />
          <Text className="mb-2 text-center text-2xl font-bold">Thank You!</Text>
          ...
          <View className="p-6">
            ...
            <View className="mb-6">
              ...
              <Text className="mt-2 text-muted-foreground">
                We value your opinion! Please share your thoughts, report issues, or suggest improvements.
              </Text>
            </View>
            ...
            >
              {loading ? (
                ...
                <View className="flex-row items-center">
                  ...
                  />
                  <Text className="font-medium text-primary-foreground">Submit Feedback</Text>
                </View>
              )}
            </Button>
          </View>
